 ...
 * <p></p>
 *
 * Makes use of {@link YepSwerveModuleState} to add the angular
 * velocity that is required of the module as an output.
 */
public class SecondSwerveKinematics extends SwerveDriveKinematics {
    ...
    private final YepSwerveModuleState[] m_moduleStates;
     ...
     */
    public SecondSwerveKinematics(Translation2d... wheelsMeters) {
        super(wheelsMeters);
        ...
        m_moduleStates = new YepSwerveModuleState[m_numModules];
        Arrays.fill(m_moduleStates, new YepSwerveModuleState());
     ...
     *     attainable max velocity. Use the {@link #desaturateWheelSpeeds(YepSwerveModuleState[], double)
     *     DesaturateWheelSpeeds} function to rectify this issue.
     */
    @SuppressWarnings("PMD.MethodReturnsInternalArray")
    public YepSwerveModuleState[] toSwerveModuleStates(
        ...
        for (int i = 0; i < m_numModules; i++) {
            ...
            m_moduleStates[i] = new YepSwerveModuleState(speed, angle, omega);
        }
     ...
     */
    public YepSwerveModuleState[] toSwerveModuleStates(ChassisSpeeds chassisSpeeds) {
     ...
     */
    public ChassisSpeeds toChassisSpeeds(YepSwerveModuleState... wheelStates) {
    ...
    public static void desaturateWheelSpeeds(
            YepSwerveModuleState[] moduleStates, double attainableMaxSpeedMetersPerSecond) {
     ...
     */
    public static void desaturateWheelSpeeds(
            YepSwerveModuleState[] moduleStates,
