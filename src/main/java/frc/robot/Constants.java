...
public class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = 157+180 + 180 ;//Math.toRadians(88.5); //ID 0

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 5;//11; // FIXME Set back right drive motor ID
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 7;//13; // FIXME Set back right steer motor ID
    public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 6;//12; // FIXME Set back right steer encoder ID

    // public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 16.87;//Math.toRadians(16.87); //ID 1
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 80.59 + 180  ;//198 - 180;//1.1;//15.9;//Math.toRadians(16.87); //ID 1

    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 11;//5; // FIXME Set back left drive motor ID
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 13;//7; // FIXME Set back left steer motor ID
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 12;//6; // FIXME Set back left steer encoder ID
    // public static final double BACK_LEFT_MODULE_STEER_OFFSET = 67.32;//Math.toRadians(67.32); //ID 2
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = 198 - 180 + 180  ;//80.59;//Math.toRadians(67.32); //ID 2
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = 85 + 180+180 + 180  ;//-149;//-125.6;//0.43-90;//Math.toRadians(352.08); //ID 3
