...
public class ArmIOSparkMax implements ArmIO {
  ...
  public ArmIOSparkMax() {
    ...
    shoulderSparkMax.setCANTimeout(Constants.configCANTimeout);
    shoulderSparkMaxFollower.setCANTimeout(Constants.configCANTimeout);
    elbowSparkMax.setCANTimeout(Constants.configCANTimeout);
